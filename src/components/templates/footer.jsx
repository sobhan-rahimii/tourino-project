...
function Footer() {
  return (
    <>
      <div className="w-full max-w-[1270px] px-[31px] lg:px-10 lg:mx-auto">
        <div className="  bg-white   lg:pt-10 lg:flex lg:items-start lg:justify-between ">
          <div></div>
          <div className="flex flex-row items-start justify-between lg:flex lg:items-start lg:justify-between lg:gap-9">
            <div className=" flex flex-col lg:flex lg:flex-col lg:items-center lg:mb-[37px] ">
          ...
          <div className="">
            <div className=" flex  flex-row-reverse justify-between  lg:flex lg:flex-col lg:items-end ">
              <div className="flex flex-col">
                ...
                <div className="  lg:flex gap-1 mt-[20px]">
                  <p>تلفن پشتیبانی:</p>
                  <span>021-8574</span>
                </div>
              </div>
              ...
              <div className=" flex flex-wrap  lg:flex lg:items-center lg:mt-[36px] lg:gap-6">
                <Image
